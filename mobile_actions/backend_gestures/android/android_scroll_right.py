...
if __name__ == '__main__':
    ...
    gallery_locator = AppiumBy.ACCESSIBILITY_ID, 'Gallery'
    gallery_element = wait.until(EC.visibility_of_element_located(gallery_locator))
    gallery_element.click()

    photos_locator = AppiumBy.XPATH, '//android.widget.TextView[@content-desc = "1. Photos"]'
    photos_element = wait.until(EC.visibility_of_element_located(photos_locator))
