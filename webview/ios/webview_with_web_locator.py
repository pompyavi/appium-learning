...
def create_ios_session():
    ...
    options.include_safari_in_webviews = True #important to get webview context
    options.webview_connect_timeout = 90000
...
if __name__ == "__main__":
    ...
    element = wait.until(ec.visibility_of_element_located(
        (AppiumBy.IOS_PREDICATE, 'name == "This is HTML content inside a "')))
